...
<head>
  ...
  <meta name="description" content="A modern Fluent Design replacement for the old Metro themed flyouts present in Windows">
  <link rel="stylesheet" href="https://eartrumpet.app/vendor/bootstrap/css/bootstrap-reboot.min.css">
  <link rel="stylesheet" href="https://eartrumpet.app/style.css">
  <title>ModernFlyoutst</title>
...
<body>
  <div id="container">
    ...
    <div class='item'>
      <h1>ModernFlyouts</h1>
      <p>A modern Fluent Design replacement for the old Metro themed flyouts present in Windows</p>
      <a href='//www.microsoft.com/store/apps/9mt60qv066rp?cid=ModernFlyouts (Preview).landing'>
        <img class='badge' src="microsoft.svg" alt="Get it from Microsoft"></img>
      </a>
      <a href='//https://github.com/ModernFlyouts-Community/ModernFlyouts'>
...
<title>ModernFlyouts | A modern Fluent Design replacement for the old Metro themed flyouts present in Windows</title>
<meta name="ModernFlyouts" content="ModernFlyouts" />
...
<!-- End Jekyll SEO tag
    ...
    <link rel="stylesheet" href="/cayman/assets/css/style.css?v=1bcabf8e4c139d46ebe0678998059db53f670caf">
  </head>
  <body>
    ...
    <header class="page-header" role="banner">
      ...
      <h2 class="project-tagline">Cayman is a clean, responsive theme for GitHub Pages.</h2>
        ...
        <a href="https://github.com/ModernFlyouts-Community/ModernFlyouts" class="btn">View on GitHub</a>
      
      
        <a href="https://github.com/pages-themes/cayman/zipball/master" class="btn">Download</a>
